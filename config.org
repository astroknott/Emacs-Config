...
#+BEGIN_SRC emacs-lisp
  ...
  (ak/generate-jump-functions
   ...
   '("passelz.org" "goclub.org" "seniornicity.org" "home-server.org"))
  ...
  (ak/main-leader-key
    ...
    "M-o pp" '(ak/jump-to-passelz :wk "Passelz")
...
#+BEGIN_SRC emacs-lisp
    (use-package org
      ...
      (setq org-agenda-clockreport-parameter-plist '(:stepskip0 t :link t :maxlevel 2 :fileskip0 t :filetitle nil :hidefiles t))
