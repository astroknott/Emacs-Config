...
#+BEGIN_SRC emacs-lisp
  ...
  (ak/main-leader-key
    ...
    "M-o pi" '(ak/jump-to-ideas-expressed :wk "Ideas Expressed")
    "M-o pb" '(ak/jump-to-vidshots :wk "Bookbrush")
...
#+BEGIN_SRC emacs-lisp
      (use-package org
        ...
        (setq org-refile-use-outline-path 'file
              ...
              org-log-done t
              org-agenda-files '("~/pCloud Drive/_areas/aaron-work/emacs/tasks.org")
              org-archive-location "archive/%s_archive::datetree/"
              org-capture-templates
              '(("e" "Emacs Todo" entry
                 (file+headline "~/pCloud Drive/_areas/aaron-work/emacs/tasks.org" "Emacs")
                 "* TODO %?")
                ("m" "Masa Todo" entry
                 (file+headline "~/pCloud Drive/_areas/aaron-work/emacs/tasks.org" "Masa")
                 "* TODO %? %^{PRIORITY}p")
                ("w" "Writing Idea" entry
                 (file "~/pCloud Drive/_areas/aaron-work/emacs/writing.org")
                 "* %? %^g")
                ("b" "Book" entry
                 (file "~/pCloud Drive/_areas/aaron-work/emacs/books.org"))))
